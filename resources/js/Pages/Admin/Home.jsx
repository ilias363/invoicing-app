...
const Home = ({ logs, invoicesData, roles }) => {
    ...
    function calculateInvoiceStatuses(invoices) {
        ...
        invoices.forEach((invoice) => {
            ...
            const monthIndex =
                yearDiff * 12 + currentDate.getMonth() - invoiceDate.getMonth();
            ...
            if (isInLastFourMonths) {
                ...
                if (invoice.payment_status === "paid")
                    statusCounts.paid[index]++;
                if (invoice.payment_status === "pending")
                    statusCounts.pending[index]++;
                if (invoice.payment_status === "cancelled")
                    statusCounts.cancelled[index]++;
            }
        });
    ...
    const invoicePaymentStatus = calculateInvoiceStatuses(
